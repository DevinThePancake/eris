            ...
            const actualCall = (cb) => {
                ...
                req.once("response", (resp) => {
                    ...
                    _respStream.on("data", (str) => {
                        ...
                        this._client.emit('requests', resp, latency, method, route);

                         if ([401, 403, 429].includes(resp.statusCode)) this._client.emit('ratelimited', resp.statusCode, method, route, !!resp.headers['x-ratelimit-global']);
