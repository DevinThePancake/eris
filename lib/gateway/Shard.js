    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "INTERACTION_CREATE": {
                this.emit("interactionCreate", packet.d.message, packet.d.member, packet.d.data, packet.d.guild_id);
                break;
            }
            case "INTERACTION_UPDATE": {
                this.emit("interactionUpdate", packet.d.message, packet.d.member, packet.d.data, packet.d.guild_id);
                break;
            }
            case "INTERACTION_DELETE": {
                this.emit("interactionDelete", packet.d.message, packet.d.member, packet.d.data, packet.d.guild_id);
                break;
            }
